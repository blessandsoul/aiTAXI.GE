      ...
      <div aria-hidden="true" className="grid min-h-48 min-w-0 gap-4 lg:grid-cols-[0.72fr_1.1fr]">
        <div className="flex min-w-0 flex-col justify-between overflow-hidden rounded-xl border border-white/10 bg-white/[0.045] p-4">
          <div className="flex items-center justify-between gap-3">
            <span className="font-mono text-xs text-white/75">REQ-184</span>
          ...
          <div className="mt-8 flex items-center gap-3">
            ...
            <span className={`grid size-8 shrink-0 place-items-center rounded-full border transition-[border-color,background-color,color,transform] ${
              arrived ? 'border-[#ffc400] bg-[#ffc400] text-[#151518]' : 'border-white/25 text-white/75'
            }`}>
              <Ico
          ...
          <div className="mt-4 flex items-end justify-between font-mono text-[10px] text-white/75">
            <span>41.7001</span>
        ...
        <div className="space-y-2">
          {VEHICLES.map((vehicle) => {
            ...
            return (
              <div
                key={vehicle.id}
                className={`flex min-h-14 items-center justify-between rounded-xl border px-4 transition-[border-color,background-color,color,transform] duration-500 ${
                  selected
              ...
              >
                <span className="flex items-center gap-3">
                  <Ico
                    ...
                    className={`size-4 ${selected ? 'text-[#ffc400]' : 'text-white/75'}`}
                  />
